---
name: cruise-product-agent
title: cruise-product-agent
description: 智能助手为您提供邮轮产品的快速查询服务，随时随地获取信息。
kind: Agent
version: 0.1.0
published_with: cruiseskillbridge
---

# cruise-product-agent

> 智能助手为您提供邮轮产品的快速查询服务，随时随地获取信息。
...
```json
{ "input": "...", "skill": "cruise-product-agent" }
```
